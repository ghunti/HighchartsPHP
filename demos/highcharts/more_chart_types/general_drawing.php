...
$chart->title->text = 'Highcharts export server overview';
?>

<html>
    <head>
        <title>General drawing</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <?php $chart->printScripts(); ?>
    </head>
    <body>
        <div id="container"></div>
        <div>Note: General drawing chart is almost 100% javascript, because it doesn't follow any other chart structure</div>

...
$masterChart->chart->events->selection = new HighchartJsExpr(
    "function(event) {
...
$masterChart->xAxis->plotBands[] = array(
    'id' => "mask-before",
...
$masterChart->plotOptions->series->fillColor->linearGradient = array(
    0,
    0,
    0,
    70
);
$masterChart->plotOptions->series->fillColor->stops[] = array(
    0,
    '#4572A7'
);
$masterChart->plotOptions->series->fillColor->stops[] = array(
...
<html>
    ...
    echo $masterChart->render(null,
            ...
            function createDetail(masterChart) {
                ...
                detailChart = <?php echo $detailChart->render() ?>;
            }

...
$masterChart->xAxis->plotBands[] = array('id' => "mask-before",
...
$masterChart->series[] = array('type' => "area",
                               'name' => "USD to EUR",
...
$detailChart->series[] = array('name' => "USD to EUR",
  ...
  <body>
    ...
    <script type="text/javascript">
        ...
        function createMaster() {
            masterChart = <?php echo $masterChart->render(null, "function(masterChart) {

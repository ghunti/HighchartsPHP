...
$chart->title->text = 'USD to EUR exchange rate from 2006 through 2008';
$chart->subtitle->text = new HighchartJsExpr("document.ontouchstart === undefined ?
...
$chart->series[] = array('type' => 'area', 'name' => 'USD to EUR',
                         'pointInterval' => 24 * 3600 * 1000,
                         'pointStart' => new HighchartJsExpr("Date.UTC(2006, 0, 01)"));

$chart->series[0]->data = array(0.8446, 0.8445, 0.8444, 0.8451, 0.8418, 0.8264, 0.8258, 0.8232, 0.8233, 0.8258,

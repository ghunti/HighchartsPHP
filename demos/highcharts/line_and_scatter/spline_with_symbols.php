...
$data = array(7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2,
              array('y' => 26.5, 'marker' => array('symbol' => 'url(http://www.highcharts.com/demo/gfx/sun.png)')),
              23.3, 18.3, 13.9, 9.6);
$chart->series[] = array('name' => "Tokyo",
                           'marker' => array('symbol' => "square"),
                           'data' => $data);

$data = array(array('y' => 3.9, 'marker' => array('symbol' => 'url(http://www.highcharts.com/demo/gfx/snow.png)')),
